(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es'), require('@angular/common'), require('@ngx-formly/core'), require('rxjs/operators'), require('rxjs'), require('@angular/forms'), require('@angular/core'), require('jquery')) :
    typeof define === 'function' && define.amd ? define('ngx-formly-designer', ['exports', 'lodash-es', '@angular/common', '@ngx-formly/core', 'rxjs/operators', 'rxjs', '@angular/forms', '@angular/core', 'jquery'], factory) :
    (factory((global['ngx-formly-designer'] = {}),global.lodashEs,global.ng.common,global.core,global.rxjs.operators,global.rxjs,global.ng.forms,global.ng.core));
}(this, (function (exports,lodashEs,common,core,operators,rxjs,forms,core$1) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var FORMLY_DESIGNER_CONFIG_TOKEN = new core$1.InjectionToken('FORMLY_DESIGNER_CONFIG_TOKEN');
    var FormlyDesignerConfig = /** @class */ (function () {
        ...
        /** @nocollapse */
        FormlyDesignerConfig.ctorParameters = function () {
            return [
                { type: Array, decorators: [{ type: core$1.Inject, args: [FORMLY_DESIGNER_CONFIG_TOKEN,] }] },
                { type: core.FormlyConfig }
            ];
        };
    ...
    var FieldsService = /** @class */ (function () {
         ...
         */
            function (name, type) {
                ...
                /** @type {?} */
                var fields = lodashEs.cloneDeep(designerOption.fields || []);
    ...
    var FormlyDesignerService = /** @class */ (function () {
        function FormlyDesignerService(designerConfig, fieldsService, formlyConfig) {
            ...
            this._fields = new rxjs.BehaviorSubject([]);
            this._model = new rxjs.BehaviorSubject({});
        }
         ...
         */
            function (field) {
                ...
                /** @type {?} */
                var fields = lodashEs.cloneDeep(this.fields);
                fields.push(field);
                this.fields = fields;
                this.model = lodashEs.cloneDeep(this.model);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                ...
                this.fields = lodashEs.cloneDeep(this.fields);
                this.model = lodashEs.cloneDeep(this.model);
            };
        /**
         * @param {?} original
         ...
         */
            function (field) {
                ...
                /** @type {?} */
                var clonedField = lodashEs.cloneDeep(field);
                /** @type {?} */
         ...
         */
            function (field) {
                var _this = this;
                /** @type {?} */
                var type = lodashEs.get(field, 'templateOptions.$fieldArray.type', field.type);
                /** @type {?} */
            ...
            function (field, designed, designerFields) {
                if (isArray(designerFields)) {
                     ...
                     */function (designerField) {
                        /** @type {?} */
                        var value = lodashEs.get(field, designerField.key);
                        if (value != null && (!isString(value) || value.length > 0) && value !== designerField.defaultValue) {
                            lodashEs.set(designed, designerField.key, value);
                        }
                    }));
                }
            };
         ...
         */
            function (control, includeSelf) {
                ...
                for (var child = control, parent_1 = (control || ( /** @type {?} */({}))).parent; !!parent_1; child = parent_1, parent_1 = parent_1.parent) {
                    if (parent_1 instanceof forms.FormGroup) {
                    ...
                    else if (parent_1 instanceof forms.FormArray) {
            ...
            function (field) {
                ...
                if (field) {
                    ...
                    if (field.formControl) {
                        ...
                        lodashEs.unset(this.model, path);
                    }
                }
            };
        /**
         ...
         */
            function (control) {
                ...
                else if (parent instanceof forms.FormArray) {
        ...
        /** @nocollapse */
        FormlyDesignerService.ctorParameters = function () {
            return [
                { type: FormlyDesignerConfig },
                { type: FieldsService },
                { type: core.FormlyConfig }
    ...
    var FormlyDesignerFieldWrapperComponent = /** @class */ (function (_super) {
        ...
        function FormlyDesignerFieldWrapperComponent(changeDetector, designerConfig, elementRef, fieldsService, formlyDesignerService, zone) {
            ...
            _this.zone = zone;
            _this.editing = false;
            _this.fieldEdit = new forms.FormControl({});
            _this.fieldWrappers = [];
            _this.wrappers = [];
            return _this;
        }
         ...
         */
            function (wrapper) {
                /** @type {?} */
                var field = lodashEs.cloneDeep(this.field);
                if (field.wrappers) {
         ...
         */
            function () {
                ...
                this.fieldEdit.setValue(this.formlyDesignerService.convertField(lodashEs.cloneDeep(this.field)));
            };
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        FormlyDesignerFieldWrapperComponent.ctorParameters = function () {
            return [
    ...
    var FormlyDesignerFieldGroupWrapperComponent = /** @class */ (function (_super) {
         ...
         */
            function (field) {
                ...
                /** @type {?} */
                var updatedField = lodashEs.cloneDeep(this.field);
                updatedField.fieldGroup = isArray(updatedField.fieldGroup) ? updatedField.fieldGroup.slice() : [];
                updatedField.fieldGroup.push(field);
                rxjs.timer()
                    .pipe(operators.tap(( /**
             * @return {?}
             */function () { return _this.formlyDesignerService.updateField(_this.field, updatedField); })), operators.catchError(( /**
                 * @return {?}
                 */function () { return rxjs.NEVER; })))
                    .subscribe();
            };
        /**
         * @private
        ...
        /** @nocollapse */
        FormlyDesignerFieldGroupWrapperComponent.ctorParameters = function () {
            return [
                { type: core$1.ChangeDetectorRef },
                { type: FormlyDesignerConfig },
                { type: core$1.ElementRef },
    ...
    var FormlyDesignerComponent = /** @class */ (function () {
        function FormlyDesignerComponent(fieldsService, formBuilder, formlyDesignerService) {
            ...
            this.fieldsChange = new core$1.EventEmitter();
            this.modelChange = new core$1.EventEmitter();
            this.types = [];
            this.wrappers = [];
            this.properties = [];
            this.debugFields = [];
         ...
         */
             ...
             */function () {
                ...
                this.subscriptions.push(rxjs.merge(this.formlyDesignerService.model$, this.form.valueChanges)
         ...
         */
            function (field) {
                 ...
                 * @return {?}
                 */function () { return rxjs.NEVER; }))).subscribe();
            };
        ...
        /** @nocollapse */
        FormlyDesignerComponent.ctorParameters = function () {
            return [
                { type: FieldsService },
        ...
        FormlyDesignerComponent.propDecorators = {
            formlyFormContainer: [{ type: core$1.ViewChild, args: ['formlyFormContainer', { read: core$1.ViewContainerRef },] }],
            fieldsChange: [{ type: core$1.Output }],
            modelChange: [{ type: core$1.Output }],
            disabled: [{ type: core$1.Input }],
            fields: [{ type: core$1.Input }],
    ...
    var FieldEditorComponent = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.valueChangesSubscription = rxjs.merge(this.fieldForm.valueChanges, this.form.valueChanges)
                    .pipe(operators.debounceTime(0))
                    .subscribe(( /**
             * @return {?}
         ...
         */
            function (field) {
                ...
                this.field = lodashEs.cloneDeep(field);
            };
        /**
         * @private
         * @return {?}
        ...
        /** @nocollapse */
        FieldEditorComponent.ctorParameters = function () {
            return [
                { type: FieldsService },
                { type: forms.FormBuilder },
                { type: FormlyDesignerConfig }
        ...
        FieldEditorComponent.propDecorators = {
            fieldGroup: [{ type: core$1.Input }],
            showType: [{ type: core$1.Input }],
            showWrappers: [{ type: core$1.Input }],
            hasContent: [{ type: core$1.Input }],
            blockElRef: [{ type: core$1.ViewChild, args: ['block',] }]
        };
    ...
    var FieldPickerComponent = /** @class */ (function () {
        function FieldPickerComponent(fb, formlyDesignerConfig) {
            this.formlyDesignerConfig = formlyDesignerConfig;
            this.selected = new core$1.EventEmitter();
            this.fieldEdit = new forms.FormControl({});
            this.form = fb.group({
                type: this.type = fb.control('', forms.Validators.compose([forms.Validators.required, forms.Validators.pattern(/^\s*\S.*$/)]))
            });
        }
        ...
        /** @nocollapse */
        FieldPickerComponent.ctorParameters = function () {
            return [
                { type: forms.FormBuilder },
                { type: FormlyDesignerConfig }
            ];
        ...
        FieldPickerComponent.propDecorators = {
            modalRef: [{ type: core$1.ViewChild, args: ['modal',] }],
            selected: [{ type: core$1.Output }]
        };
    ...
    var TypeSelectComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TypeSelectComponent.ctorParameters = function () {
            return [
                { type: FormlyDesignerConfig }
            ];
        };
    ...
    var WrapperEditorComponent = /** @class */ (function () {
         ...
         */
            function (obj) {
                ...
                this.fields = this.fieldsService.getWrapperFields(this.wrapper);
                this.fieldForm = this.formBuilder.group({});
                this.field = lodashEs.cloneDeep(obj);
                this.subscribeValueChanges();
            };
        /**
         * @param {?} fn
        ...
        /** @nocollapse */
        WrapperEditorComponent.ctorParameters = function () {
            return [
                { type: FieldsService },
                { type: forms.FormBuilder }
            ];
    ...
    var WrapperSelectComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        WrapperSelectComponent.ctorParameters = function () {
            return [
                { type: FormlyDesignerConfig }
            ];
        };
    ...
    var WrapperPickerComponent = /** @class */ (function () {
         ...
         */
            function () {
                this.form = this.formBuilder.group({
                    wrapper: ['', forms.Validators.compose([forms.Validators.required, forms.Validators.pattern(/^\s*\S.*$/)])]
                });
            };
        /**
         * @return {?}
        ...
        /** @nocollapse */
        WrapperPickerComponent.ctorParameters = function () {
            return [
                { type: forms.FormBuilder },
                { type: FormlyDesignerConfig },
                { type: FormlyDesignerService }
    ...
    var WrappersPickerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        WrappersPickerComponent.ctorParameters = function () {
            return [
                { type: FormlyDesignerConfig },
                { type: FormlyDesignerService }
            ];
    ...
    function decycle(value) {
        ...
        /** @type {?} */
        var objects = new Map();
        return traverse(lodashEs.cloneDeep(value), ( /**
         * @param {?} key
         * @param {?} v
         * @return {?}
         */function (key, v) {
    ...
    var DecyclePipe = /** @class */ (function () {
        ...
        DecyclePipe.decorators = [
            { type: core$1.Pipe, args: [{ name: 'decycle' },] }
        ];
        return DecyclePipe;
    }());
    ...
    var FormlyDesignerModule = /** @class */ (function () {
         ...
         */
            function (designerConfig) {
                if (designerConfig === void 0) {
                    designerConfig = {};
                }
                return {
                    ngModule: FormlyDesignerModule,
                    providers: [
                        { provide: core$1.ANALYZE_FOR_ENTRY_COMPONENTS, useValue: [fieldComponents, wrapperComponents], multi: true },
        ...
        FormlyDesignerModule.decorators = [
            { type: core$1.NgModule, args: [{
                        ...
                        entryComponents: [core.FormlyForm]
                    },] }
        ];
        /** @nocollapse */
        FormlyDesignerModule.ctorParameters = function () {
            return [
                { type: core.FormlyConfig }
            ];
        };
    ...
    exports.wrapperComponents = wrapperComponents;
    exports.config = config;
    exports.FieldsService = FieldsService;
    exports.FORMLY_DESIGNER_CONFIG_TOKEN = FORMLY_DESIGNER_CONFIG_TOKEN;
    exports.FormlyDesignerConfig = FormlyDesignerConfig;
    exports.FormlyDesignerService = FormlyDesignerService;
    exports.FormlyDesignerComponent = FormlyDesignerComponent;
    exports.FormlyDesignerModule = FormlyDesignerModule;
    exports.decycle = decycle;
    exports.ɵe = FieldEditorComponent;
    exports.ɵf = FieldPickerComponent;
    exports.ɵg = TypeSelectComponent;
    exports.ɵh = WrapperEditorComponent;
    exports.ɵj = WrapperPickerComponent;
    exports.ɵi = WrapperSelectComponent;
    exports.ɵk = WrappersPickerComponent;
    exports.ɵl = DecyclePipe;
    exports.ɵd = TemplateDesigner;
    exports.ɵa = FormlyDesignerWrapperComponent;
    exports.ɵb = FormlyDesignerFieldWrapperComponent;
    exports.ɵc = FormlyDesignerFieldGroupWrapperComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-formly-designer.umd.js.map